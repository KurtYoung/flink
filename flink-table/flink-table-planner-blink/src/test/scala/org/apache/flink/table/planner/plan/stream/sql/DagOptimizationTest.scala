...
class DagOptimizationTest extends TableTestBase {
  ...
  def testMultiSinks1(): Unit = {
    ...
    TableEnvUtil.registerTableSink(util.tableEnv, "retractSink1", retractSink1)
    stmtSet.addInsert("retractSink1", table2)

    val retractSink2 = util.createRetractTableSink(Array("total_min"), Array(INT))
    TableEnvUtil.registerTableSink(util.tableEnv, "retractSink2", retractSink2)
  ...
  def testMultiSinks2(): Unit = {
    ...
    TableEnvUtil.registerTableSink(util.tableEnv, "appendSink1", appendSink1)
    stmtSet.addInsert("appendSink1", table3)

    val appendSink2 = util.createAppendTableSink(Array("a", "b1"), Array(INT, LONG))
    TableEnvUtil.registerTableSink(util.tableEnv, "appendSink2", appendSink2)
  ...
  def testMultiSinksSplitOnUnion1(): Unit = {
    ...
    TableEnvUtil.registerTableSink(util.tableEnv, "upsertSink", upsertSink)
    ...
    TableEnvUtil.registerTableSink(util.tableEnv, "retractSink", retractSink)
  ...
  def testMultiSinksSplitOnUnion2(): Unit = {
    ...
    TableEnvUtil.registerTableSink(util.tableEnv, "appendSink3", appendSink3)
  ...
  def testMultiSinksSplitOnUnion3(): Unit = {
    ...
    TableEnvUtil.registerTableSink(util.tableEnv, "appendSink", appendSink)
